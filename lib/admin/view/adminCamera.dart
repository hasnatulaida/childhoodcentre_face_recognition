...
import 'package:face_recognition/picture/view/utils.dart';
...
class AdminCameraPage extends StatefulWidget {
  ...
  AdminCameraPage(this.image, this.dataFace, this.categoryImage);

  @override
  _AdminCameraPageState createState() => _AdminCameraPageState();
}
...
class _AdminCameraPageState extends State<AdminCameraPage> {
  ...
  void _saveFile() {
    ...
    Navigator.of(context).pushReplacement(MaterialPageRoute(builder: (_) {
      return AdminProfileEdit(imageStaff, dataFaceList, widget.categoryImage);
    }));
  }
        ...
        children: <Widget>[
          ...
          FloatingActionButton.extended(
            ...
            onPressed: () async {
              await Navigator.of(context)
                  .pushReplacement(MaterialPageRoute(builder: (_) {
                return AdminCameraPage(
                    widget.image, widget.dataFace, widget.categoryImage);
              }));
            },
            label: Text('Cancel'),
