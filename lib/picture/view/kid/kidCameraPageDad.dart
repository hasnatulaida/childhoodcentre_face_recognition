...
class KidCameraPageDad extends StatefulWidget {
  ...
  @override
  _KidCameraPageDadState createState() => _KidCameraPageDadState();
}

class _KidCameraPageDadState extends State<KidCameraPageDad> {
  var dataNew;
  dynamic dataFace = {};
    ...
    if (widget.pageNavigate == navigate) {
      ...
      Navigator.of(context).pushReplacement(MaterialPageRoute(builder: (_) {
        return ProfileKidView(
            ...
            widget.categoryImageMomPage,
            widget.categoryImageDadPage,
            widget.kidID,true,widget.kidDate);
      }));
  }
