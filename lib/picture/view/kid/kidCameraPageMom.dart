...
class KidCameraPageMom extends StatefulWidget {
  ...
  @override
  _KidCameraPageMomState createState() => _KidCameraPageMomState();
}

class _KidCameraPageMomState extends State<KidCameraPageMom> {
  var dataNew;
  dynamic dataFace = {};
