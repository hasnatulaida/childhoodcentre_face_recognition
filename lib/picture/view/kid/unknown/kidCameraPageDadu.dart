...
class KidCameraPageDadUnrecognize extends StatefulWidget {
  ...
  @override
  _KidCameraPageDadUnrecognizeState createState() =>
      _KidCameraPageDadUnrecognizeState();
}

class _KidCameraPageDadUnrecognizeState
    extends State<KidCameraPageDadUnrecognize> {
  var dataNew;
  dynamic dataFace = {};
