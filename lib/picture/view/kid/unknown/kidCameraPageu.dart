...
class KidCameraPageUnrecognize extends StatefulWidget {
  KidCameraPageUnrecognize(
      this.dataFace,
      this.dataFaceMom,
      this.dataFaceDad,
      this.image,
  ...
  final String user;
  @override
  _KidCameraPageUnrecognizeState createState() =>
      _KidCameraPageUnrecognizeState();
}

class _KidCameraPageUnrecognizeState extends State<KidCameraPageUnrecognize> {
  var dataNew;
  dynamic dataFace = {};
                ...
                //BUAT NI
                  Navigator.of(context)
                    ...
                    return NewProfileKidUnrecognize(
                        ...
                        widget.categoryImagePage,
                        widget.categoryImageMomPage,
                        widget.categoryImageDadPage,widget.uid,widget.user);
                  }));
              },
            ),
          ],
