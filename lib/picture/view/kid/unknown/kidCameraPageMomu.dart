...
class KidCameraPageMomUnrecognize extends StatefulWidget {
  ...
  KidCameraPageMomUnrecognize(
      ...
      this.user);
  @override
  _KidCameraPageMomUnrecognizeState createState() => _KidCameraPageMomUnrecognizeState();
}

class _KidCameraPageMomUnrecognizeState extends State<KidCameraPageMomUnrecognize> {
  var dataNew;
  dynamic dataFace = {};
